  ...
  const contactMethods: ContactMethod[] = [
    {
      ...
      details: [
        "Diatomite, Off Nakuru – Nairobi Highway, Gilgil, Kenya P.O. BOX 334 -20116 ",
      ],
  ...
  return (
    <div className="contact-page">
      ...
      <section className="contact-hero">
        <div className="contact-hero-overlay">
          ...
          <p className="contact-hero-subtitle">
            Connect with our team to learn more about our seed conservation
            efforts
          </p>
        </div>
      </section>
      ...
      <div className="contact-container">
        ...
        {/* Donation CTA - Only Inactive Button */}
        <section className="contact-donation-cta">
          <div className="contact-donation-content">
            ...
            <div className="contact-cta-buttons">
              <button
                className="contact-cta-button contact-cta-button-inactive"
                disabled
