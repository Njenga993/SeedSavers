...
import seedBankImg from '../assets/seed_pic.jpg';
import regenerationImg from '../assets/seed_pic.jpg';
import geneBankImg from '../assets/seed_pic.jpg';
import seedExchangeImg from '../assets/seed_pic.jpg';
import agroecologyImg from '../assets/seed_pic.jpg';
import ambassadorImg from '../assets/seed_pic.jpg';
import valueAdditionImg from '../assets/seed_pic.jpg';
import learningCenterImg from '../assets/seed_pic.jpg';
import policyImg from '../assets/seed_pic.jpg';
import farmerAdvocacyImg from '../assets/seed_pic.jpg';
import seedFairsImg from '../assets/seed_pic.jpg';
// Import journey images
import foundingImg from '../assets/seed_pic.jpg';
import expansionImg from '../assets/seed_pic.jpg';
import recognitionImg from '../assets/seed_pic.jpg';
      ...
      <div className="container">
        ...
        <div className="about-intro-content">
          ...
          <div className="about-stats">
            ...
            <div className="stat-item">
              <h3>105</h3>
              <p>Community Seed Banks</p>
            </div>
            <div className="stat-item">
              <h3>3,000+</h3>
              <p>Seed Varieties Conserved</p>
            </div>
            <div className="stat-item">
              <h3>8</h3>
              <p>Counties Served</p>
